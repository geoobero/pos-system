    ...
    return (
        <>
            ...
            <aside className={`
                ...
                w-40 lg:bg-slate-900 backdrop-blur-sm lg:text-gray-50 text-black flex flex-col
            ...
            `}>
                ...
                <nav className="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
                    <Link href="/dashboard/pos" className="items-center block px-3 py-2 text-xs rounded max-w-30 hover:text-amber-400 duration-300 flex flex-col gap-2">
                        <span>
                    ...
                    <Link href="/dashboard/transactions" className="items-center block px-3 py-2 text-xs flex-col max-w-30 rounded hover:text-amber-400 duration-300 flex gap-2">
                        <span>
                    ...
                    {isAdmin && (
                        <>
                            ...
                            <Link href="/dashboard/overview" className="flex gap-2 items-center text-xs flex-col max-w-30 block px-3 py-2 rounded hover:text-amber-400 duration-300">
                                <span>
                            ...
                            <Link href="/dashboard/categories" className="flex gap-2 items-center flex-col text-xs max-w-30 block px-3 py-2 hover:text-amber-400 rounded duration-300">
                                <span>
                            ...
                            <Link href="/dashboard/products" className="flex gap-2 items-center flex-col text-xs max-w-30 block px-3 py-2 rounded hover:text-amber-400 duration-300">
                                <span>
                            ...
                            <Link href="/dashboard/users" className="flex gap-2 items-center flex-col text-xs max-w-30 block px-3 py-2 rounded hover:text-amber-400 duration-300">
                                <span>
