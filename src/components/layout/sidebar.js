    ...
    return (
        <>
            ...
            <aside className={`
                ...
                w-64 lg:bg-slate-900 md:bg-red-800/40 backdrop-blur-sm text-gray-50 flex flex-col
            ...
            `}>
                ...
                <nav className="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
                    <Link href="/dashboard/pos" className="items-center block px-3 py-2 rounded hover:text-amber-400 duration-300 flex gap-2">
                        <span>
                            <svg class="w-8 h-8 text-gray-800 dark:text-sky-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <Link href="/dashboard/transactions" className="items-center block px-3 py-2 rounded hover:text-amber-400 duration-300 flex gap-2">
                        <span>
                            <svg class="w-8 h-8 text-gray-800 dark:text-amber-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    {isAdmin && (
                        <>
                            ...
                            <Link href="/dashboard/overview" className="flex gap-2 items-center block px-3 py-2 rounded hover:text-amber-400 duration-300">
                                <span>
                                    <svg class="w-8 h-8 text-gray-800 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <Link href="/dashboard/categories" className="flex gap-2 items-center block px-3 py-2 hover:text-amber-400 rounded duration-300">
                                <span>
                                    <svg class="w-8 h-8 text-gray-800 dark:text-teal-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                        <path fillRule="evenodd" d="M5 4a2 2 0 0 0-2 2v1h10.968l-1.9-2.28A2 2 0 0 0 10.532 4H5ZM3 19V9h18v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Zm9-8.5a1 1 0 0 1 1 1V13h1.5a1 1 0 1 1 0 2H13v1.5a1 1 0 1 1-2 0V15H9.5a1 1 0 1 1 0-2H11v-1.5a1 1 0 0 1 1-1Z" clip-rule="evenodd" />
                                    </svg>
                            ...
                            <Link href="/dashboard/products" className="flex gap-2 items-center block px-3 py-2 rounded hover:text-amber-400 duration-300">
                                <span>
                                    <svg class="w-8 h-8 text-gray-800 dark:text-purple-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <Link href="/dashboard/users" className="flex gap-2 items-center block px-3 py-2 rounded hover:text-amber-400 duration-300">
                                <span>
                                    <svg class="w-8 h-8 text-gray-800 dark:text-blue-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
